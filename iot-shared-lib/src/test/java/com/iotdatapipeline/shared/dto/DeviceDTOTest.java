...
public class DeviceDTOTest {
    ...
    public void setup() {
        ...
        deviceDTO = new DeviceDTO("device_1", "sensor");
    }
    ...
    public void testConstructor() {
        ...
        DeviceDTO newDeviceDTO = new DeviceDTO("device_3", "lightbulb");
    ...
    public void testToString() {
        ...
        String expectedString = "DeviceDTO(id=device_1, deviceType=sensor)";
    ...
    public void testEqualsAndHashCode() {
        ...
        DeviceDTO deviceDTO1 = new DeviceDTO("device_1", "sensor");
        DeviceDTO deviceDTO2 = new DeviceDTO("device_1", "sensor");
